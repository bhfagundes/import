...
class CreateConteudoTributarioPlanParaTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_Para', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_Para');
	}
