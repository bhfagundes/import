...
class CreateConteudoTributarioPlanCearaTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_Ceara', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_Ceara');
	}
