...
class CreateConteudoTributarioPlanRiodeJaneiroTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_RiodeJaneiro', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_RiodeJaneiro');
	}
