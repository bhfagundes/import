...
class CreateConteudoTributarioPlanTocantinsTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_Tocantins', function(Blueprint $table)
		{
			...
			$table->text('Processos', 65535)->nullable();
			...
			$table->text('ID_Tipo_Efeito', 65535)->nullable();
	...
	{
		Schema::drop('conteudo_tributario_plan_Tocantins');
	}
