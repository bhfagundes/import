...
class CreateConteudoTributarioPlanParanaTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_Parana', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_Parana');
	}
