...
class CreateConteudoTributarioPlanMinasGeraisTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_MinasGerais', function(Blueprint $table)
		{
			...
			$table->text('Data_busca_obg', 65535)->nullable();
	...
	{
		Schema::drop('conteudo_tributario_plan_MinasGerais');
	}
