...
class CreateConteudoTributarioPlanMatoGrossoTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_MatoGrosso', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_MatoGrosso');
	}
