...
class CreateConteudoTributarioPlanAcreTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_Acre', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_Acre');
	}
