...
class CreateConteudoTributarioPlanGoiasTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_Goias', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_Goias');
	}
