...
class CreateConteudoTributarioPlanMunicipalTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_Municipal', function(Blueprint $table)
		{
			...
			$table->text('Optantes pelo simples', 65535)->nullable();
		});
	}
	...
	{
		Schema::drop('conteudo_tributario_plan_Municipal');
	}
