...
class CreateConteudoTributarioPlanRondoniaTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_Rondonia', function(Blueprint $table)
		{
			...
			$table->text('MyUnknownColumn', 65535)->nullable();
			$table->text('MyUnknownColumn_[0]', 65535)->nullable();
		});
	}
	...
	{
		Schema::drop('conteudo_tributario_plan_Rondonia');
	}
