...
class CreateConteudoTributarioPlanSergipeTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_Sergipe', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_Sergipe');
	}
