...
class CreateConteudoTributarioPlanMatoGrossodoSul2Table extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_MatoGrossodoSul2', function(Blueprint $table)
		{
			...
			$table->text('cnae', 65535)->nullable();
			$table->text('id_cnae', 65535)->nullable();
		});
	}
	...
	{
		Schema::drop('conteudo_tributario_plan_MatoGrossodoSul2');
	}
