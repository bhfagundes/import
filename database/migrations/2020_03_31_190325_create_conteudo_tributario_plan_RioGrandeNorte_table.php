...
class CreateConteudoTributarioPlanRioGrandeNorteTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_RioGrandeNorte', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_RioGrandeNorte');
	}
