...
class CreateConteudoTributarioPlanParaibaTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_Paraiba', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_Paraiba');
	}
