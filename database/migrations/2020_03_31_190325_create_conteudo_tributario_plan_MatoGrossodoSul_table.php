...
class CreateConteudoTributarioPlanMatoGrossodoSulTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_MatoGrossodoSul', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_MatoGrossodoSul');
	}
