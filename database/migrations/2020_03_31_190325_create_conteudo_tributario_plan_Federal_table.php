...
class CreateConteudoTributarioPlanFederalTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_Federal', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_Federal');
	}
