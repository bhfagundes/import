...
class CreateConteudoTributarioPlanSaoPauloTable extends Migration {
	...
	public function up()
	{
		Schema::create('conteudo_tributario_plan_SaoPaulo', function(Blueprint $table)
		{
	...
	{
		Schema::drop('conteudo_tributario_plan_SaoPaulo');
	}
